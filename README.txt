...
The pywws-livelog file is for your init.d folder.  It will start a livelog process as a daemon on startup (if you have run update-rc.d pywws-livelog defaults).
