...
The pywws-livelog file is for your init.d folder.  It will start a livelog process as a deamon on startup (if you have run update-rc.d pywws-livelog defaults).
...
In all cass you will need toadjust these files for locations/names and of course you are responsible afor anythingyou add to your system.
